// cppreference link https://en.cppreference.com/w/cpp/algorithm/ranges/starts_with
#include <algorithm>
#include <iostream>
#include <ranges>
#include <string_view>
...
int main()
{
    ...
    static_assert(std::ranges::starts_with(v, std::views::iota(1) | std::views::filter(odd) | std::views::take(3)));
}
