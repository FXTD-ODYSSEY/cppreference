// cppreference link https://en.cppreference.com/w/cpp/feature_test
...
int main()
{
    ...
    if (print.cxx11 && print.core_features)
        show("C++11 CORE", cxx11_core);
    if (print.cxx14 && print.core_features)
        show("C++14 CORE", cxx14_core);
    if (print.cxx14 && print.lib_features)
        show("C++14 LIB", cxx14_lib);
    ...
    if (print.cxx26 && print.core_features)
        show("C++26 CORE", cxx26_core);
    if (print.cxx26 && print.lib_features)
        show("C++26 LIB", cxx26_lib);
    if (print.attributes)
