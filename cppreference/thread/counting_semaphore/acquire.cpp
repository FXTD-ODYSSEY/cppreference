// cppreference link https://en.cppreference.com/w/cpp/thread/counting_semaphore/acquire
#include <array>
#include <chrono>
#include <cstddef>
#include <iomanip>
...
public:
    ...
    void occupy_sema()
    {
        wait_on_sema = static_cast<unsigned>(std::chrono::duration_cast<std::chrono::milliseconds>(
