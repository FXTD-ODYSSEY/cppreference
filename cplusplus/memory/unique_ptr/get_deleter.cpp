// cplusplus link https://cplusplus.com/reference/memory\unique_ptr\get_deleter
...
int main()
{
    ...
    std::cout << "resetting alpha...";
    alpha.reset(new int);
    std::cout << "resetting beta...";
    beta.reset(new int);
    std::cout << "resetting gamma...";
    gamma.reset(new int);
    std::cout << "resetting delta...";
    delta.reset(new int);
